...
class NewTests(GAETestCase):
    def test_success(self):
        ...
        mock_resp = Mock()
        json_response = rest.new(mock_resp, foto='foto_string', tit='1', map='1')
    ...
    def test_error(self):
        ...
        self.assertSetEqual(set(['tit', 'map']), set(errors.keys()))
        self.assert_can_serialize_as_json(json_response)
...
class EditTests(GAETestCase):
    def test_success(self):
        ...
        mock_resp = Mock()
        json_response = rest.edit(mock_resp, jogo.key.id(), foto='foto_string', tit='1', map='1')
